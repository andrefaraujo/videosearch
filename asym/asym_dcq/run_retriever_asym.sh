...
QUERY_INDEX_FILE=${QUERY_CLUTTERED_FILE%.txt}.sift_scfv_idx_k${GAUSSIANS}_shot_n${FPSHOT}_m${SHOT_MODE}
INDEX_FILE=database_list_public.sift_scfv_idx_k${GAUSSIANS}
